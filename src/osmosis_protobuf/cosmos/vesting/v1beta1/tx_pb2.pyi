...
class MsgCreateClawbackVestingAccount(_message.Message):
    ...
    def __init__(self, from_address: _Optional[str]=..., to_address: _Optional[str]=..., start_time: _Optional[int]=..., lockup_periods: _Optional[_Iterable[_Union[_vesting_pb2.Period, _Mapping]]]=..., vesting_periods: _Optional[_Iterable[_Union[_vesting_pb2.Period, _Mapping]]]=..., merge: bool=...) -> None:
        ...
...
class MsgClawback(_message.Message):
    __slots__ = ('funder_address', 'address', 'dest_address')
    ...
    def __init__(self, funder_address: _Optional[str]=..., address: _Optional[str]=..., dest_address: _Optional[str]=...) -> None:
        ...

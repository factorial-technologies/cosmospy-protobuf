...
class ClawbackVestingAccount(_message.Message):
    ...
    funder_address: str
    start_time: int
    lockup_periods: _containers.RepeatedCompositeFieldContainer[Period]
    vesting_periods: _containers.RepeatedCompositeFieldContainer[Period]

    def __init__(self, base_vesting_account: _Optional[_Union[BaseVestingAccount, _Mapping]]=..., funder_address: _Optional[str]=..., start_time: _Optional[int]=..., lockup_periods: _Optional[_Iterable[_Union[Period, _Mapping]]]=..., vesting_periods: _Optional[_Iterable[_Union[Period, _Mapping]]]=...) -> None:
        ...
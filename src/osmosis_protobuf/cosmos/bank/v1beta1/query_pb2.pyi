...
class QueryTotalSupplyWithoutOffsetRequest(_message.Message):
    __slots__ = ('pagination',)
    PAGINATION_FIELD_NUMBER: _ClassVar[int]
    pagination: _pagination_pb2.PageRequest
...
class QueryTotalSupplyWithoutOffsetResponse(_message.Message):
    __slots__ = ('supply', 'pagination')
    SUPPLY_FIELD_NUMBER: _ClassVar[int]
    PAGINATION_FIELD_NUMBER: _ClassVar[int]
    supply: _containers.RepeatedCompositeFieldContainer[_coin_pb2.Coin]
...
class QuerySupplyOfWithoutOffsetRequest(_message.Message):
    __slots__ = ('denom',)
    DENOM_FIELD_NUMBER: _ClassVar[int]
    denom: str
...
class QuerySupplyOfWithoutOffsetResponse(_message.Message):
    __slots__ = ('amount',)
    AMOUNT_FIELD_NUMBER: _ClassVar[int]
    amount: _coin_pb2.Coin

...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'Z&github.com/CosmWasm/wasmd/x/wasm/types'
    ...
    _globals['_GENESISSTATE'].fields_by_name['codes']._serialized_options = b'\xc8\xde\x1f\x00\xea\xde\x1f\x0fcodes,omitempty\xa8\xe7\xb0*\x01'
    _globals['_GENESISSTATE'].fields_by_name['contracts']._options = None
    _globals['_GENESISSTATE'].fields_by_name['contracts']._serialized_options = b'\xc8\xde\x1f\x00\xea\xde\x1f\x13contracts,omitempty\xa8\xe7\xb0*\x01'
    _globals['_GENESISSTATE'].fields_by_name['sequences']._options = None
    _globals['_GENESISSTATE'].fields_by_name['sequences']._serialized_options = b'\xc8\xde\x1f\x00\xea\xde\x1f\x13sequences,omitempty\xa8\xe7\xb0*\x01'
    _globals['_CODE'].fields_by_name['code_id']._options = None
    _globals['_CODE'].fields_by_name['code_id']._serialized_options = b'\xe2\xde\x1f\x06CodeID'
    _globals['_CODE'].fields_by_name['code_info']._options = None
    _globals['_CODE'].fields_by_name['code_info']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_CONTRACT'].fields_by_name['contract_info']._options = None
    _globals['_CONTRACT'].fields_by_name['contract_info']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_CONTRACT'].fields_by_name['contract_state']._options = None
    _globals['_CONTRACT'].fields_by_name['contract_state']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_CONTRACT'].fields_by_name['contract_code_history']._options = None
    _globals['_CONTRACT'].fields_by_name['contract_code_history']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_SEQUENCE'].fields_by_name['id_key']._options = None
    _globals['_SEQUENCE'].fields_by_name['id_key']._serialized_options = b'\xe2\xde\x1f\x05IDKey'

...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_GENESISSTATE'].fields_by_name['feetokens']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_TXFEESTRACKER'].fields_by_name['tx_fees']._options = None
    _globals['_TXFEESTRACKER'].fields_by_name['tx_fees']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_TXFEESTRACKER'].fields_by_name['height_accounting_starts_from']._options = None
    _globals['_TXFEESTRACKER'].fields_by_name['height_accounting_starts_from']._serialized_options = b'\xf2\xde\x1f$yaml:"height_accounting_starts_from"'

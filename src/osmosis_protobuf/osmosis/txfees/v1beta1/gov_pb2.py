...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_UPDATEFEETOKENPROPOSAL'].fields_by_name['title']._options = None
    _globals['_UPDATEFEETOKENPROPOSAL'].fields_by_name['title']._serialized_options = b'\xf2\xde\x1f\x0cyaml:"title"'
    _globals['_UPDATEFEETOKENPROPOSAL'].fields_by_name['description']._options = None
    _globals['_UPDATEFEETOKENPROPOSAL'].fields_by_name['description']._serialized_options = b'\xf2\xde\x1f\x12yaml:"description"'
    _globals['_UPDATEFEETOKENPROPOSAL'].fields_by_name['feetokens']._options = None
    _globals['_UPDATEFEETOKENPROPOSAL'].fields_by_name['feetokens']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x11yaml:"fee_tokens"'
    _globals['_UPDATEFEETOKENPROPOSAL']._options = None
    _globals['_UPDATEFEETOKENPROPOSAL']._serialized_options = b'\x88\xa0\x1f\x00\x98\xa0\x1f\x00\xe8\xa0\x1f\x01\xca\xb4-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*\x1eosmosis/UpdateFeeTokenProposal'

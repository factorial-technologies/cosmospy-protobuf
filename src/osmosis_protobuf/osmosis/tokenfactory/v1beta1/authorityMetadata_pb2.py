...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_DENOMAUTHORITYMETADATA'].fields_by_name['admin']._options = None
    _globals['_DENOMAUTHORITYMETADATA'].fields_by_name['admin']._serialized_options = b'\xf2\xde\x1f\x0cyaml:"admin"'
    _globals['_DENOMAUTHORITYMETADATA']._options = None
    _globals['_DENOMAUTHORITYMETADATA']._serialized_options = b'\xe8\xa0\x1f\x01'

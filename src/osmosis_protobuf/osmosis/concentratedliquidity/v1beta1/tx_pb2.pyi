...
class MsgTransferPositions(_message.Message):
    __slots__ = ('position_ids', 'sender', 'new_owner')
    POSITION_IDS_FIELD_NUMBER: _ClassVar[int]
    SENDER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, position_ids: _Optional[_Iterable[int]]=..., sender: _Optional[str]=..., new_owner: _Optional[str]=...) -> None:
        ...

class MsgTransferPositionsResponse(_message.Message):
    __slots__ = ()

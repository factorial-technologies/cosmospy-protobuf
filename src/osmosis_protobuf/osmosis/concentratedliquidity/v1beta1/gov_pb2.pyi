...
class PoolRecord(_message.Message):
    __slots__ = ('denom0', 'denom1', 'tick_spacing', 'spread_factor')
    ...
    def __init__(self, denom0: _Optional[str]=..., denom1: _Optional[str]=..., tick_spacing: _Optional[int]=..., spread_factor: _Optional[str]=...) -> None:
        ...
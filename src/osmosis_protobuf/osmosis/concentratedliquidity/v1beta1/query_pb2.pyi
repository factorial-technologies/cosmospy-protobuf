...
from osmosis.concentratedliquidity import params_pb2 as _params_pb2
from osmosis.concentratedliquidity.v1beta1 import tickInfo_pb2 as _tickInfo_pb2
...
from osmosis.concentratedliquidity.v1beta1 import position_pb2 as _position_pb2
from osmosis.concentratedliquidity.v1beta1 import incentive_record_pb2 as _incentive_record_pb2
...
class LiquidityNetInDirectionResponse(_message.Message):
    __slots__ = ('liquidity_depths', 'current_tick', 'current_liquidity', 'current_sqrt_price')
    ...
    def __init__(self, liquidity_depths: _Optional[_Iterable[_Union[TickLiquidityNet, _Mapping]]]=..., current_tick: _Optional[int]=..., current_liquidity: _Optional[str]=..., current_sqrt_price: _Optional[str]=...) -> None:
        ...
...
class LiquidityPerTickRangeResponse(_message.Message):
    __slots__ = ('liquidity', 'bucket_index')
    ...
    def __init__(self, liquidity: _Optional[_Iterable[_Union[LiquidityDepthWithRange, _Mapping]]]=..., bucket_index: _Optional[int]=...) -> None:
        ...
...
class NumNextInitializedTicksRequest(_message.Message):
    __slots__ = ('pool_id', 'token_in_denom', 'num_next_initialized_ticks')
    POOL_ID_FIELD_NUMBER: _ClassVar[int]
    TOKEN_IN_DENOM_FIELD_NUMBER: _ClassVar[int]
    NUM_NEXT_INITIALIZED_TICKS_FIELD_NUMBER: _ClassVar[int]
    pool_id: int
    token_in_denom: str
    num_next_initialized_ticks: int

    def __init__(self, pool_id: _Optional[int]=..., token_in_denom: _Optional[str]=..., num_next_initialized_ticks: _Optional[int]=...) -> None:
        ...

class NumNextInitializedTicksResponse(_message.Message):

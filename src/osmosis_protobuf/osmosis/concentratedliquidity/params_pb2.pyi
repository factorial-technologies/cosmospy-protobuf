...
class Params(_message.Message):
    __slots__ = ('authorized_tick_spacing', 'authorized_spread_factors', 'balancer_shares_reward_discount', 'authorized_quote_denoms', 'authorized_uptimes', 'is_permissionless_pool_creation_enabled', 'unrestricted_pool_creator_whitelist', 'hook_gas_limit')
    ...
    UNRESTRICTED_POOL_CREATOR_WHITELIST_FIELD_NUMBER: _ClassVar[int]
    HOOK_GAS_LIMIT_FIELD_NUMBER: _ClassVar[int]
    ...
    unrestricted_pool_creator_whitelist: _containers.RepeatedScalarFieldContainer[str]
    hook_gas_limit: int

    def __init__(self, authorized_tick_spacing: _Optional[_Iterable[int]]=..., authorized_spread_factors: _Optional[_Iterable[str]]=..., balancer_shares_reward_discount: _Optional[str]=..., authorized_quote_denoms: _Optional[_Iterable[str]]=..., authorized_uptimes: _Optional[_Iterable[_Union[_duration_pb2.Duration, _Mapping]]]=..., is_permissionless_pool_creation_enabled: bool=..., unrestricted_pool_creator_whitelist: _Optional[_Iterable[str]]=..., hook_gas_limit: _Optional[int]=...) -> None:
        ...
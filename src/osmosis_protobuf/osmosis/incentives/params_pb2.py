...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_PARAMS'].fields_by_name['distr_epoch_identifier']._options = None
    _globals['_PARAMS'].fields_by_name['distr_epoch_identifier']._serialized_options = b'\xf2\xde\x1f\x1dyaml:"distr_epoch_identifier"'
    _globals['_PARAMS'].fields_by_name['group_creation_fee']._options = None
    _globals['_PARAMS'].fields_by_name['group_creation_fee']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_PARAMS'].fields_by_name['unrestricted_creator_whitelist']._options = None
    _globals['_PARAMS'].fields_by_name['unrestricted_creator_whitelist']._serialized_options = b'\xf2\xde\x1f%yaml:"unrestricted_creator_whitelist"'

...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'ZJgithub.com/osmosis-labs/osmosis/v21/x/cosmwasmpool/cosmwasm/msg/transmuter'
    _globals['_JOINPOOLEXECUTEMSGREQUEST'].fields_by_name['join_pool']._options = None
    _globals['_JOINPOOLEXECUTEMSGREQUEST'].fields_by_name['join_pool']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_EXITPOOLEXECUTEMSGREQUEST'].fields_by_name['exit_pool']._options = None
    _globals['_EXITPOOLEXECUTEMSGREQUEST'].fields_by_name['exit_pool']._serialized_options = b'\xc8\xde\x1f\x00'

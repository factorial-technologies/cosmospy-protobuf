...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_COSMWASMPOOL'].fields_by_name['contract_address']._serialized_options = b'\xf2\xde\x1f\x17yaml:"contract_address"'
    _globals['_COSMWASMPOOL'].fields_by_name['instantiate_msg']._options = None
    _globals['_COSMWASMPOOL'].fields_by_name['instantiate_msg']._serialized_options = b'\xf2\xde\x1f\x16yaml:"instantiate_msg"'
    _globals['_COSMWASMPOOL']._options = None
    _globals['_COSMWASMPOOL']._serialized_options = b'\x88\xa0\x1f\x00\x98\xa0\x1f\x00\xca\xb4-\x05PoolI'

...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_CALCOUTAMTGIVENIN'].fields_by_name['token_in']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CALCOUTAMTGIVENIN'].fields_by_name['swap_fee']._options = None
    _globals['_CALCOUTAMTGIVENIN'].fields_by_name['swap_fee']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDec'
    _globals['_CALCOUTAMTGIVENINREQUEST'].fields_by_name['calc_out_amt_given_in']._options = None
    _globals['_CALCOUTAMTGIVENINREQUEST'].fields_by_name['calc_out_amt_given_in']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CALCOUTAMTGIVENINRESPONSE'].fields_by_name['token_out']._options = None
    _globals['_CALCOUTAMTGIVENINRESPONSE'].fields_by_name['token_out']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CALCINAMTGIVENOUT'].fields_by_name['token_out']._options = None
    _globals['_CALCINAMTGIVENOUT'].fields_by_name['token_out']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CALCINAMTGIVENOUT'].fields_by_name['swap_fee']._options = None
    _globals['_CALCINAMTGIVENOUT'].fields_by_name['swap_fee']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDec'
    _globals['_CALCINAMTGIVENOUTREQUEST'].fields_by_name['calc_in_amt_given_out']._options = None
    _globals['_CALCINAMTGIVENOUTREQUEST'].fields_by_name['calc_in_amt_given_out']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CALCINAMTGIVENOUTRESPONSE'].fields_by_name['token_in']._options = None
    _globals['_CALCINAMTGIVENOUTRESPONSE'].fields_by_name['token_in']._serialized_options = b'\xc8\xde\x1f\x00'

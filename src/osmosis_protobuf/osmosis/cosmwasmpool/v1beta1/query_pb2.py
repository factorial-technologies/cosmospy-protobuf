...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'ZDgithub.com/osmosis-labs/osmosis/v21/x/cosmwasmpool/client/queryproto'
    ...
    _globals['_CONTRACTINFOBYPOOLIDREQUEST'].fields_by_name['pool_id']._options = None
    _globals['_CONTRACTINFOBYPOOLIDREQUEST'].fields_by_name['pool_id']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"pool_id"'
    _globals['_CONTRACTINFOBYPOOLIDRESPONSE'].fields_by_name['contract_address']._options = None
    _globals['_CONTRACTINFOBYPOOLIDRESPONSE'].fields_by_name['contract_address']._serialized_options = b'\xf2\xde\x1f\x17yaml:"contract_address"'
    _globals['_CONTRACTINFOBYPOOLIDRESPONSE'].fields_by_name['code_id']._options = None
    _globals['_CONTRACTINFOBYPOOLIDRESPONSE'].fields_by_name['code_id']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"code_id"'
    _globals['_QUERY'].methods_by_name['Pools']._options = None
    _globals['_QUERY'].methods_by_name['Pools']._serialized_options = b'\x82\xd3\xe4\x93\x02%\x12#/osmosis/cosmwasmpool/v1beta1/pools'
    _globals['_QUERY'].methods_by_name['Params']._options = None
    _globals['_QUERY'].methods_by_name['Params']._serialized_options = b'\x82\xd3\xe4\x93\x02&\x12$/osmosis/cosmwasmpool/v1beta1/params'
    _globals['_QUERY'].methods_by_name['ContractInfoByPoolId']._options = None
    _globals['_QUERY'].methods_by_name['ContractInfoByPoolId']._serialized_options = b'\x82\xd3\xe4\x93\x02-\x12+/osmosis/cosmwasmpool/v1beta1/contract_info'

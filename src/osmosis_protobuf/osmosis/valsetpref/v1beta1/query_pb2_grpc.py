...
import grpc
from ....osmosis.valsetpref.v1beta1 import query_pb2 as osmosis_dot_valsetpref_dot_v1beta1_dot_query__pb2
...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.UserValidatorPreferences = channel.unary_unary('/osmosis.valsetpref.v1beta1.Query/UserValidatorPreferences', request_serializer=osmosis_dot_valsetpref_dot_v1beta1_dot_query__pb2.UserValidatorPreferencesRequest.SerializeToString, response_deserializer=osmosis_dot_valsetpref_dot_v1beta1_dot_query__pb2.UserValidatorPreferencesResponse.FromString)
...
def add_QueryServicer_to_server(servicer, server):
    rpc_method_handlers = {'UserValidatorPreferences': grpc.unary_unary_rpc_method_handler(servicer.UserValidatorPreferences, request_deserializer=osmosis_dot_valsetpref_dot_v1beta1_dot_query__pb2.UserValidatorPreferencesRequest.FromString, response_serializer=osmosis_dot_valsetpref_dot_v1beta1_dot_query__pb2.UserValidatorPreferencesResponse.SerializeToString)}

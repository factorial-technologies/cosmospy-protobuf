...
from osmosis.valsetpref.v1beta1 import state_pb2 as _state_pb2
...
class MsgUndelegateFromRebalancedValidatorSet(_message.Message):
    __slots__ = ('delegator', 'coin')
    DELEGATOR_FIELD_NUMBER: _ClassVar[int]
    COIN_FIELD_NUMBER: _ClassVar[int]
    delegator: str
...
class MsgUndelegateFromRebalancedValidatorSetResponse(_message.Message):
    __slots__ = ()

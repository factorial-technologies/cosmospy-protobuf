...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_POOLTYPE']._serialized_options = b'\x88\xa3\x1e\x00'
    _globals['_MODULEROUTE'].fields_by_name['pool_id']._options = None
    _globals['_MODULEROUTE'].fields_by_name['pool_id']._serialized_options = b'\xc8\xde\x1f\x01\xf2\xde\x1f\x0eyaml:"pool_id"'

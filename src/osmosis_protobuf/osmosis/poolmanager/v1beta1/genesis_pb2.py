...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_PARAMS'].fields_by_name['pool_creation_fee']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x18yaml:"pool_creation_fee"\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_PARAMS'].fields_by_name['taker_fee_params']._options = None
    _globals['_PARAMS'].fields_by_name['taker_fee_params']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x17yaml:"taker_fee_params"'
    ...
    _globals['_GENESISSTATE'].fields_by_name['pool_routes']._options = None
    _globals['_GENESISSTATE'].fields_by_name['pool_routes']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['denom_pair_taker_fee_store']._options = None
    _globals['_GENESISSTATE'].fields_by_name['denom_pair_taker_fee_store']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_TAKERFEEPARAMS'].fields_by_name['default_taker_fee']._options = None
    _globals['_TAKERFEEPARAMS'].fields_by_name['default_taker_fee']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDec\xe2\xde\x1f\x0fDefaultTakerFee'
    _globals['_TAKERFEEPARAMS'].fields_by_name['osmo_taker_fee_distribution']._options = None
    _globals['_TAKERFEEPARAMS'].fields_by_name['osmo_taker_fee_distribution']._serialized_options = b'\xc8\xde\x1f\x00\xe2\xde\x1f\x18OsmoTakerFeeDistribution'
    _globals['_TAKERFEEPARAMS'].fields_by_name['non_osmo_taker_fee_distribution']._options = None
    _globals['_TAKERFEEPARAMS'].fields_by_name['non_osmo_taker_fee_distribution']._serialized_options = b'\xc8\xde\x1f\x00\xe2\xde\x1f\x1bNonOsmoTakerFeeDistribution'
    _globals['_TAKERFEEPARAMS'].fields_by_name['admin_addresses']._options = None
    _globals['_TAKERFEEPARAMS'].fields_by_name['admin_addresses']._serialized_options = b'\xf2\xde\x1f\x16yaml:"admin_addresses"'
    _globals['_TAKERFEEPARAMS'].fields_by_name['community_pool_denom_to_swap_non_whitelisted_assets_to']._options = None
    _globals['_TAKERFEEPARAMS'].fields_by_name['community_pool_denom_to_swap_non_whitelisted_assets_to']._serialized_options = b'\xf2\xde\x1f=yaml:"community_pool_denom_to_swap_non_whitelisted_assets_to"'
    _globals['_TAKERFEEPARAMS'].fields_by_name['reduced_fee_whitelist']._options = None
    _globals['_TAKERFEEPARAMS'].fields_by_name['reduced_fee_whitelist']._serialized_options = b'\xf2\xde\x1f\x1cyaml:"reduced_fee_whitelist"'
    _globals['_TAKERFEEDISTRIBUTIONPERCENTAGE'].fields_by_name['staking_rewards']._options = None
    _globals['_TAKERFEEDISTRIBUTIONPERCENTAGE'].fields_by_name['staking_rewards']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDec\xf2\xde\x1f\x16yaml:"staking_rewards"'
    _globals['_TAKERFEEDISTRIBUTIONPERCENTAGE'].fields_by_name['community_pool']._options = None
    _globals['_TAKERFEEDISTRIBUTIONPERCENTAGE'].fields_by_name['community_pool']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDec\xf2\xde\x1f\x15yaml:"community_pool"'
    _globals['_TAKERFEESTRACKER'].fields_by_name['taker_fees_to_stakers']._options = None
    _globals['_TAKERFEESTRACKER'].fields_by_name['taker_fees_to_stakers']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_TAKERFEESTRACKER'].fields_by_name['taker_fees_to_community_pool']._options = None
    _globals['_TAKERFEESTRACKER'].fields_by_name['taker_fees_to_community_pool']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_TAKERFEESTRACKER'].fields_by_name['height_accounting_starts_from']._options = None
    _globals['_TAKERFEESTRACKER'].fields_by_name['height_accounting_starts_from']._serialized_options = b'\xf2\xde\x1f$yaml:"height_accounting_starts_from"'
    _globals['_POOLVOLUME'].fields_by_name['pool_volume']._options = None
    _globals['_POOLVOLUME'].fields_by_name['pool_volume']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'

...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_PARAMS'].fields_by_name['enabled']._options = None
    _globals['_PARAMS'].fields_by_name['enabled']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"enabled"'
    _globals['_PARAMS'].fields_by_name['admin']._options = None
    _globals['_PARAMS'].fields_by_name['admin']._serialized_options = b'\xf2\xde\x1f\x0cyaml:"admin"'

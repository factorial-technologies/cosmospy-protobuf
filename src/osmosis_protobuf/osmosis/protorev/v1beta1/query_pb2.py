...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['params']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\ryaml:"params"'
    _globals['_QUERYGETPROTOREVNUMBEROFTRADESRESPONSE'].fields_by_name['number_of_trades']._options = None
    _globals['_QUERYGETPROTOREVNUMBEROFTRADESRESPONSE'].fields_by_name['number_of_trades']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f\x15cosmossdk.io/math.Int\xf2\xde\x1f\x17yaml:"number_of_trades"'
    _globals['_QUERYGETPROTOREVPROFITSBYDENOMREQUEST'].fields_by_name['denom']._options = None
    _globals['_QUERYGETPROTOREVPROFITSBYDENOMREQUEST'].fields_by_name['denom']._serialized_options = b'\xf2\xde\x1f\x0cyaml:"denom"'
    _globals['_QUERYGETPROTOREVPROFITSBYDENOMRESPONSE'].fields_by_name['profit']._options = None
    _globals['_QUERYGETPROTOREVPROFITSBYDENOMRESPONSE'].fields_by_name['profit']._serialized_options = b'\xf2\xde\x1f\ryaml:"profit"'
    _globals['_QUERYGETPROTOREVALLPROFITSRESPONSE'].fields_by_name['profits']._options = None
    _globals['_QUERYGETPROTOREVALLPROFITSRESPONSE'].fields_by_name['profits']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x0eyaml:"profits"'
    _globals['_QUERYGETPROTOREVSTATISTICSBYROUTEREQUEST'].fields_by_name['route']._options = None
    _globals['_QUERYGETPROTOREVSTATISTICSBYROUTEREQUEST'].fields_by_name['route']._serialized_options = b'\xf2\xde\x1f\x0cyaml:"route"'
    _globals['_QUERYGETPROTOREVSTATISTICSBYROUTERESPONSE'].fields_by_name['statistics']._options = None
    _globals['_QUERYGETPROTOREVSTATISTICSBYROUTERESPONSE'].fields_by_name['statistics']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x11yaml:"statistics"'
    _globals['_QUERYGETPROTOREVALLROUTESTATISTICSRESPONSE'].fields_by_name['statistics']._options = None
    _globals['_QUERYGETPROTOREVALLROUTESTATISTICSRESPONSE'].fields_by_name['statistics']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x11yaml:"statistics"'
    _globals['_QUERYGETPROTOREVTOKENPAIRARBROUTESRESPONSE'].fields_by_name['routes']._options = None
    _globals['_QUERYGETPROTOREVTOKENPAIRARBROUTESRESPONSE'].fields_by_name['routes']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\ryaml:"routes"'
    _globals['_QUERYGETPROTOREVADMINACCOUNTRESPONSE'].fields_by_name['admin_account']._options = None
    _globals['_QUERYGETPROTOREVADMINACCOUNTRESPONSE'].fields_by_name['admin_account']._serialized_options = b'\xf2\xde\x1f\x14yaml:"admin_account"'
    _globals['_QUERYGETPROTOREVDEVELOPERACCOUNTRESPONSE'].fields_by_name['developer_account']._options = None
    _globals['_QUERYGETPROTOREVDEVELOPERACCOUNTRESPONSE'].fields_by_name['developer_account']._serialized_options = b'\xf2\xde\x1f\x18yaml:"developer_account"'
    _globals['_QUERYGETPROTOREVINFOBYPOOLTYPERESPONSE'].fields_by_name['info_by_pool_type']._options = None
    _globals['_QUERYGETPROTOREVINFOBYPOOLTYPERESPONSE'].fields_by_name['info_by_pool_type']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x18yaml:"info_by_pool_type"'
    _globals['_QUERYGETPROTOREVMAXPOOLPOINTSPERBLOCKRESPONSE'].fields_by_name['max_pool_points_per_block']._options = None
    _globals['_QUERYGETPROTOREVMAXPOOLPOINTSPERBLOCKRESPONSE'].fields_by_name['max_pool_points_per_block']._serialized_options = b'\xf2\xde\x1f yaml:"max_pool_points_per_block"'
    _globals['_QUERYGETPROTOREVMAXPOOLPOINTSPERTXRESPONSE'].fields_by_name['max_pool_points_per_tx']._options = None
    _globals['_QUERYGETPROTOREVMAXPOOLPOINTSPERTXRESPONSE'].fields_by_name['max_pool_points_per_tx']._serialized_options = b'\xf2\xde\x1f\x1dyaml:"max_pool_points_per_tx"'
    _globals['_QUERYGETPROTOREVBASEDENOMSRESPONSE'].fields_by_name['base_denoms']._options = None
    _globals['_QUERYGETPROTOREVBASEDENOMSRESPONSE'].fields_by_name['base_denoms']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x12yaml:"base_denoms"'
    _globals['_QUERYGETPROTOREVENABLEDRESPONSE'].fields_by_name['enabled']._options = None
    _globals['_QUERYGETPROTOREVENABLEDRESPONSE'].fields_by_name['enabled']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"enabled"'
    _globals['_QUERYGETPROTOREVPOOLREQUEST'].fields_by_name['base_denom']._options = None
    _globals['_QUERYGETPROTOREVPOOLREQUEST'].fields_by_name['base_denom']._serialized_options = b'\xf2\xde\x1f\x11yaml:"base_denom"'
    _globals['_QUERYGETPROTOREVPOOLREQUEST'].fields_by_name['other_denom']._options = None
    _globals['_QUERYGETPROTOREVPOOLREQUEST'].fields_by_name['other_denom']._serialized_options = b'\xf2\xde\x1f\x12yaml:"other_denom"'
    _globals['_QUERYGETPROTOREVPOOLRESPONSE'].fields_by_name['pool_id']._options = None
    _globals['_QUERYGETPROTOREVPOOLRESPONSE'].fields_by_name['pool_id']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"pool_id"'
    _globals['_QUERYGETALLPROTOCOLREVENUERESPONSE'].fields_by_name['all_protocol_revenue']._options = None
    _globals['_QUERYGETALLPROTOCOLREVENUERESPONSE'].fields_by_name['all_protocol_revenue']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x1byaml:"all_protocol_revenue"'
    _globals['_QUERY'].methods_by_name['Params']._options = None
    _globals['_QUERY'].methods_by_name['Params']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1a\x12\x18/osmosis/protorev/params'
    _globals['_QUERY'].methods_by_name['GetProtoRevNumberOfTrades']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevNumberOfTrades']._serialized_options = b'\x82\xd3\xe4\x93\x02$\x12"/osmosis/protorev/number_of_trades'
    _globals['_QUERY'].methods_by_name['GetProtoRevProfitsByDenom']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevProfitsByDenom']._serialized_options = b'\x82\xd3\xe4\x93\x02$\x12"/osmosis/protorev/profits_by_denom'
    _globals['_QUERY'].methods_by_name['GetProtoRevAllProfits']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevAllProfits']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1f\x12\x1d/osmosis/protorev/all_profits'
    _globals['_QUERY'].methods_by_name['GetProtoRevStatisticsByRoute']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevStatisticsByRoute']._serialized_options = b"\x82\xd3\xe4\x93\x02'\x12%/osmosis/protorev/statistics_by_route"
    _globals['_QUERY'].methods_by_name['GetProtoRevAllRouteStatistics']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevAllRouteStatistics']._serialized_options = b'\x82\xd3\xe4\x93\x02(\x12&/osmosis/protorev/all_route_statistics'
    _globals['_QUERY'].methods_by_name['GetProtoRevTokenPairArbRoutes']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevTokenPairArbRoutes']._serialized_options = b"\x82\xd3\xe4\x93\x02)\x12'/osmosis/protorev/token_pair_arb_routes"
    _globals['_QUERY'].methods_by_name['GetProtoRevAdminAccount']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevAdminAccount']._serialized_options = b'\x82\xd3\xe4\x93\x02!\x12\x1f/osmosis/protorev/admin_account'
    _globals['_QUERY'].methods_by_name['GetProtoRevDeveloperAccount']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevDeveloperAccount']._serialized_options = b'\x82\xd3\xe4\x93\x02%\x12#/osmosis/protorev/developer_account'
    _globals['_QUERY'].methods_by_name['GetProtoRevInfoByPoolType']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevInfoByPoolType']._serialized_options = b'\x82\xd3\xe4\x93\x02%\x12#/osmosis/protorev/info_by_pool_type'
    _globals['_QUERY'].methods_by_name['GetProtoRevMaxPoolPointsPerTx']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevMaxPoolPointsPerTx']._serialized_options = b'\x82\xd3\xe4\x93\x02*\x12(/osmosis/protorev/max_pool_points_per_tx'
    _globals['_QUERY'].methods_by_name['GetProtoRevMaxPoolPointsPerBlock']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevMaxPoolPointsPerBlock']._serialized_options = b'\x82\xd3\xe4\x93\x02-\x12+/osmosis/protorev/max_pool_points_per_block'
    _globals['_QUERY'].methods_by_name['GetProtoRevBaseDenoms']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevBaseDenoms']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1f\x12\x1d/osmosis/protorev/base_denoms'
    _globals['_QUERY'].methods_by_name['GetProtoRevEnabled']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevEnabled']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1b\x12\x19/osmosis/protorev/enabled'
    _globals['_QUERY'].methods_by_name['GetProtoRevPool']._options = None
    _globals['_QUERY'].methods_by_name['GetProtoRevPool']._serialized_options = b'\x82\xd3\xe4\x93\x02\x18\x12\x16/osmosis/protorev/pool'
    _globals['_QUERY'].methods_by_name['GetAllProtocolRevenue']._options = None
    _globals['_QUERY'].methods_by_name['GetAllProtocolRevenue']._serialized_options = b'\x82\xd3\xe4\x93\x02(\x12&/osmosis/protorev/all_protocol_revenue'

...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_TOKENPAIRARBROUTES'].fields_by_name['arb_routes']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x11yaml:"arb_routes"'
    _globals['_TOKENPAIRARBROUTES'].fields_by_name['token_in']._options = None
    _globals['_TOKENPAIRARBROUTES'].fields_by_name['token_in']._serialized_options = b'\xf2\xde\x1f\x0fyaml:"token_in"'
    _globals['_TOKENPAIRARBROUTES'].fields_by_name['token_out']._options = None
    _globals['_TOKENPAIRARBROUTES'].fields_by_name['token_out']._serialized_options = b'\xf2\xde\x1f\x10yaml:"token_out"'
    _globals['_TOKENPAIRARBROUTES']._options = None
    _globals['_TOKENPAIRARBROUTES']._serialized_options = b'\xe8\xa0\x1f\x01'
    _globals['_ROUTE'].fields_by_name['trades']._options = None
    _globals['_ROUTE'].fields_by_name['trades']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\ryaml:"trades"'
    _globals['_ROUTE'].fields_by_name['step_size']._options = None
    _globals['_ROUTE'].fields_by_name['step_size']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f\x15cosmossdk.io/math.Int\xf2\xde\x1f\x10yaml:"step_size"'
    _globals['_ROUTE']._options = None
    _globals['_ROUTE']._serialized_options = b'\xe8\xa0\x1f\x01'
    _globals['_TRADE'].fields_by_name['pool']._options = None
    _globals['_TRADE'].fields_by_name['pool']._serialized_options = b'\xf2\xde\x1f\x0byaml:"pool"'
    _globals['_TRADE'].fields_by_name['token_in']._options = None
    _globals['_TRADE'].fields_by_name['token_in']._serialized_options = b'\xf2\xde\x1f\x0fyaml:"token_in"'
    _globals['_TRADE'].fields_by_name['token_out']._options = None
    _globals['_TRADE'].fields_by_name['token_out']._serialized_options = b'\xf2\xde\x1f\x10yaml:"token_out"'
    _globals['_TRADE']._options = None
    _globals['_TRADE']._serialized_options = b'\xe8\xa0\x1f\x01'
    _globals['_ROUTESTATISTICS'].fields_by_name['profits']._options = None
    _globals['_ROUTESTATISTICS'].fields_by_name['profits']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x0eyaml:"profits"'
    _globals['_ROUTESTATISTICS'].fields_by_name['number_of_trades']._options = None
    _globals['_ROUTESTATISTICS'].fields_by_name['number_of_trades']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f\x15cosmossdk.io/math.Int\xf2\xde\x1f\x17yaml:"number_of_trades"'
    _globals['_ROUTESTATISTICS'].fields_by_name['route']._options = None
    _globals['_ROUTESTATISTICS'].fields_by_name['route']._serialized_options = b'\xf2\xde\x1f\x0cyaml:"route"'
    _globals['_POOLWEIGHTS'].fields_by_name['stable_weight']._options = None
    _globals['_POOLWEIGHTS'].fields_by_name['stable_weight']._serialized_options = b'\xf2\xde\x1f\x14yaml:"stable_weight"'
    _globals['_POOLWEIGHTS'].fields_by_name['balancer_weight']._options = None
    _globals['_POOLWEIGHTS'].fields_by_name['balancer_weight']._serialized_options = b'\xf2\xde\x1f\x16yaml:"balancer_weight"'
    _globals['_POOLWEIGHTS'].fields_by_name['concentrated_weight']._options = None
    _globals['_POOLWEIGHTS'].fields_by_name['concentrated_weight']._serialized_options = b'\xf2\xde\x1f\x1ayaml:"concentrated_weight"'
    _globals['_POOLWEIGHTS'].fields_by_name['cosmwasm_weight']._options = None
    _globals['_POOLWEIGHTS'].fields_by_name['cosmwasm_weight']._serialized_options = b'\xf2\xde\x1f\x16yaml:"cosmwasm_weight"'
    _globals['_INFOBYPOOLTYPE'].fields_by_name['stable']._options = None
    _globals['_INFOBYPOOLTYPE'].fields_by_name['stable']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\ryaml:"stable"'
    _globals['_INFOBYPOOLTYPE'].fields_by_name['balancer']._options = None
    _globals['_INFOBYPOOLTYPE'].fields_by_name['balancer']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x0fyaml:"balancer"'
    _globals['_INFOBYPOOLTYPE'].fields_by_name['concentrated']._options = None
    _globals['_INFOBYPOOLTYPE'].fields_by_name['concentrated']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x13yaml:"concentrated"'
    _globals['_INFOBYPOOLTYPE'].fields_by_name['cosmwasm']._options = None
    _globals['_INFOBYPOOLTYPE'].fields_by_name['cosmwasm']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x0fyaml:"cosmwasm"'
    _globals['_STABLEPOOLINFO'].fields_by_name['weight']._options = None
    _globals['_STABLEPOOLINFO'].fields_by_name['weight']._serialized_options = b'\xf2\xde\x1f\ryaml:"weight"'
    _globals['_BALANCERPOOLINFO'].fields_by_name['weight']._options = None
    _globals['_BALANCERPOOLINFO'].fields_by_name['weight']._serialized_options = b'\xf2\xde\x1f\ryaml:"weight"'
    _globals['_CONCENTRATEDPOOLINFO'].fields_by_name['weight']._options = None
    _globals['_CONCENTRATEDPOOLINFO'].fields_by_name['weight']._serialized_options = b'\xf2\xde\x1f\ryaml:"weight"'
    _globals['_CONCENTRATEDPOOLINFO'].fields_by_name['max_ticks_crossed']._options = None
    _globals['_CONCENTRATEDPOOLINFO'].fields_by_name['max_ticks_crossed']._serialized_options = b'\xf2\xde\x1f\x18yaml:"max_ticks_crossed"'
    _globals['_COSMWASMPOOLINFO'].fields_by_name['weight_maps']._options = None
    _globals['_COSMWASMPOOLINFO'].fields_by_name['weight_maps']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x12yaml:"weight_maps"'
    _globals['_WEIGHTMAP'].fields_by_name['weight']._options = None
    _globals['_WEIGHTMAP'].fields_by_name['weight']._serialized_options = b'\xf2\xde\x1f\ryaml:"weight"'
    _globals['_WEIGHTMAP'].fields_by_name['contract_address']._options = None
    _globals['_WEIGHTMAP'].fields_by_name['contract_address']._serialized_options = b'\xf2\xde\x1f\x17yaml:"contract_address"'
    _globals['_BASEDENOM'].fields_by_name['denom']._options = None
    _globals['_BASEDENOM'].fields_by_name['denom']._serialized_options = b'\xf2\xde\x1f\x0cyaml:"denom"'
    _globals['_BASEDENOM'].fields_by_name['step_size']._options = None
    _globals['_BASEDENOM'].fields_by_name['step_size']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f\x15cosmossdk.io/math.Int\xf2\xde\x1f\x10yaml:"step_size"'
    _globals['_ALLPROTOCOLREVENUE'].fields_by_name['taker_fees_tracker']._options = None
    _globals['_ALLPROTOCOLREVENUE'].fields_by_name['taker_fees_tracker']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x19yaml:"taker_fees_tracker"'
    _globals['_ALLPROTOCOLREVENUE'].fields_by_name['tx_fees_tracker']._options = None
    _globals['_ALLPROTOCOLREVENUE'].fields_by_name['tx_fees_tracker']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x16yaml:"tx_fees_tracker"'
    _globals['_ALLPROTOCOLREVENUE'].fields_by_name['cyclic_arb_tracker']._options = None
    _globals['_ALLPROTOCOLREVENUE'].fields_by_name['cyclic_arb_tracker']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x19yaml:"cyclic_arb_tracker"'
    _globals['_CYCLICARBTRACKER'].fields_by_name['cyclic_arb']._options = None
    _globals['_CYCLICARBTRACKER'].fields_by_name['cyclic_arb']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_CYCLICARBTRACKER'].fields_by_name['height_accounting_starts_from']._options = None
    _globals['_CYCLICARBTRACKER'].fields_by_name['height_accounting_starts_from']._serialized_options = b'\xf2\xde\x1f$yaml:"height_accounting_starts_from"'

...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_GENESISSTATE'].fields_by_name['minter']._serialized_options = b'\xc8\xde\x1f\x00'
    ...
    _globals['_GENESISSTATE'].fields_by_name['reduction_started_epoch']._options = None
    _globals['_GENESISSTATE'].fields_by_name['reduction_started_epoch']._serialized_options = b'\xf2\xde\x1f\x1eyaml:"reduction_started_epoch"'

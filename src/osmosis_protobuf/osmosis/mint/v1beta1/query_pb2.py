...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_QUERYEPOCHPROVISIONSRESPONSE'].fields_by_name['epoch_provisions']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDec'
    _globals['_QUERY'].methods_by_name['Params']._options = None
    _globals['_QUERY'].methods_by_name['Params']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1e\x12\x1c/osmosis/mint/v1beta1/params'
    _globals['_QUERY'].methods_by_name['EpochProvisions']._options = None
    _globals['_QUERY'].methods_by_name['EpochProvisions']._serialized_options = b'\x82\xd3\xe4\x93\x02(\x12&/osmosis/mint/v1beta1/epoch_provisions'
    ...
    _globals['_QUERYEPOCHPROVISIONSRESPONSE']._serialized_end = 364

...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_GENESISSTATE'].fields_by_name['superfluid_assets']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['osmo_equivalent_multipliers']._options = None
    _globals['_GENESISSTATE'].fields_by_name['osmo_equivalent_multipliers']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['intermediary_accounts']._options = None
    _globals['_GENESISSTATE'].fields_by_name['intermediary_accounts']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['intemediary_account_connections']._options = None
    _globals['_GENESISSTATE'].fields_by_name['intemediary_account_connections']._serialized_options = b'\xc8\xde\x1f\x00'

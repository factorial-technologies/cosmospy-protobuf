...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'ZDgithub.com/cosmos/ibc-go/v4/modules/light-clients/09-localhost/types'
    _globals['_CLIENTSTATE'].fields_by_name['chain_id']._options = None
    _globals['_CLIENTSTATE'].fields_by_name['chain_id']._serialized_options = b'\xf2\xde\x1f\x0fyaml:"chain_id"'
    _globals['_CLIENTSTATE'].fields_by_name['height']._options = None
    _globals['_CLIENTSTATE'].fields_by_name['height']._serialized_options = b'\xc8\xde\x1f\x00'

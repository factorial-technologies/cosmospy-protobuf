...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_METADATA'].fields_by_name['fee_version']._serialized_options = b'\xf2\xde\x1f\x12yaml:"fee_version"'
    _globals['_METADATA'].fields_by_name['app_version']._options = None
    _globals['_METADATA'].fields_by_name['app_version']._serialized_options = b'\xf2\xde\x1f\x12yaml:"app_version"'

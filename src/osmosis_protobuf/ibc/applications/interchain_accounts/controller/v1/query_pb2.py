...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'ZPgithub.com/cosmos/ibc-go/v4/modules/apps/27-interchain-accounts/controller/types'
    _globals['_QUERYINTERCHAINACCOUNTREQUEST'].fields_by_name['connection_id']._options = None
    ...
    _globals['_QUERY'].methods_by_name['InterchainAccount']._options = None

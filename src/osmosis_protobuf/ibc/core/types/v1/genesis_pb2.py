...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'Z.github.com/cosmos/ibc-go/v4/modules/core/types'
    _globals['_GENESISSTATE'].fields_by_name['client_genesis']._options = None
    _globals['_GENESISSTATE'].fields_by_name['client_genesis']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x15yaml:"client_genesis"'
    _globals['_GENESISSTATE'].fields_by_name['connection_genesis']._options = None
    _globals['_GENESISSTATE'].fields_by_name['connection_genesis']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x19yaml:"connection_genesis"'
    _globals['_GENESISSTATE'].fields_by_name['channel_genesis']._options = None
    _globals['_GENESISSTATE'].fields_by_name['channel_genesis']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x16yaml:"channel_genesis"'

...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'Z<github.com/cosmos/ibc-go/v4/modules/core/23-commitment/types'
    _globals['_MERKLEROOT']._options = None
    _globals['_MERKLEROOT']._serialized_options = b'\x88\xa0\x1f\x00'
    _globals['_MERKLEPREFIX'].fields_by_name['key_prefix']._options = None
    _globals['_MERKLEPREFIX'].fields_by_name['key_prefix']._serialized_options = b'\xf2\xde\x1f\x11yaml:"key_prefix"'
    _globals['_MERKLEPATH'].fields_by_name['key_path']._options = None
    _globals['_MERKLEPATH'].fields_by_name['key_path']._serialized_options = b'\xf2\xde\x1f\x0fyaml:"key_path"'
    _globals['_MERKLEPATH']._options = None
    _globals['_MERKLEPATH']._serialized_options = b'\x98\xa0\x1f\x00'

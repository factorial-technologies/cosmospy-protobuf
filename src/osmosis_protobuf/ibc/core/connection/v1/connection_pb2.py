...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_CONNECTIONEND'].fields_by_name['client_id']._serialized_options = b'\xf2\xde\x1f\x10yaml:"client_id"'
    _globals['_CONNECTIONEND'].fields_by_name['counterparty']._options = None
    _globals['_CONNECTIONEND'].fields_by_name['counterparty']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CONNECTIONEND'].fields_by_name['delay_period']._options = None
    _globals['_CONNECTIONEND'].fields_by_name['delay_period']._serialized_options = b'\xf2\xde\x1f\x13yaml:"delay_period"'
    _globals['_CONNECTIONEND']._options = None
    _globals['_CONNECTIONEND']._serialized_options = b'\x88\xa0\x1f\x00'
    _globals['_IDENTIFIEDCONNECTION'].fields_by_name['id']._options = None
    _globals['_IDENTIFIEDCONNECTION'].fields_by_name['id']._serialized_options = b'\xf2\xde\x1f\tyaml:"id"'
    _globals['_IDENTIFIEDCONNECTION'].fields_by_name['client_id']._options = None
    _globals['_IDENTIFIEDCONNECTION'].fields_by_name['client_id']._serialized_options = b'\xf2\xde\x1f\x10yaml:"client_id"'
    _globals['_IDENTIFIEDCONNECTION'].fields_by_name['counterparty']._options = None
    _globals['_IDENTIFIEDCONNECTION'].fields_by_name['counterparty']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_IDENTIFIEDCONNECTION'].fields_by_name['delay_period']._options = None
    _globals['_IDENTIFIEDCONNECTION'].fields_by_name['delay_period']._serialized_options = b'\xf2\xde\x1f\x13yaml:"delay_period"'
    _globals['_IDENTIFIEDCONNECTION']._options = None
    _globals['_IDENTIFIEDCONNECTION']._serialized_options = b'\x88\xa0\x1f\x00'
    _globals['_COUNTERPARTY'].fields_by_name['client_id']._options = None
    _globals['_COUNTERPARTY'].fields_by_name['client_id']._serialized_options = b'\xf2\xde\x1f\x10yaml:"client_id"'
    _globals['_COUNTERPARTY'].fields_by_name['connection_id']._options = None
    _globals['_COUNTERPARTY'].fields_by_name['connection_id']._serialized_options = b'\xf2\xde\x1f\x14yaml:"connection_id"'
    _globals['_COUNTERPARTY'].fields_by_name['prefix']._options = None
    _globals['_COUNTERPARTY'].fields_by_name['prefix']._serialized_options = b'\xc8\xde\x1f\x00'
    ...
    _globals['_CONNECTIONPATHS'].fields_by_name['client_id']._serialized_options = b'\xf2\xde\x1f\x10yaml:"client_id"'
    _globals['_VERSION']._options = None
    _globals['_VERSION']._serialized_options = b'\x88\xa0\x1f\x00'
    _globals['_PARAMS'].fields_by_name['max_expected_time_per_block']._options = None
    _globals['_PARAMS'].fields_by_name['max_expected_time_per_block']._serialized_options = b'\xf2\xde\x1f"yaml:"max_expected_time_per_block"'

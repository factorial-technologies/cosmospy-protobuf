...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_GENESISSTATE'].fields_by_name['connections']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['client_connection_paths']._options = None
    _globals['_GENESISSTATE'].fields_by_name['client_connection_paths']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x1eyaml:"client_connection_paths"'
    _globals['_GENESISSTATE'].fields_by_name['next_connection_sequence']._options = None
    _globals['_GENESISSTATE'].fields_by_name['next_connection_sequence']._serialized_options = b'\xf2\xde\x1f\x1fyaml:"next_connection_sequence"'
